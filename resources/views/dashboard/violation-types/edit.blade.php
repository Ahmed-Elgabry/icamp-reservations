...
@section('pageTitle', __('dashboard.edit_violation_type'))
        ...
        <div class="card-header border-0 pt-6">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">
                    @lang('dashboard.edit_violation_type')
                </span>
            </h3>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="is_active" class="form-select form-select-solid">
                                <option value="1" {{ $violationType->is_active ? 'selected' : '' }}>@lang('dashboard.active')</option>
                                <option value="0" {{ !$violationType->is_active ? 'selected' : '' }}>@lang('dashboard.inactive')</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control form-control-solid" rows="3">
                                {{ old('description', $violationType->description) }}
                            </textarea>
                        </div>
                    </div>
                </div>
