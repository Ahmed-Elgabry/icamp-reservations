...
<div class="modal fade" id="chargeImagePreviewModal" tabindex="-1" aria-labelledby="chargeImagePreviewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <style>
            ...
            #kt_ecommerce_add_product_submit .indicator-label,
            #edit_charge_submit .indicator-label {
                display: inline-block !important;
            }

            #kt_ecommerce_add_product_submit .indicator-progress,
            #edit_charge_submit .indicator-progress {
            ...
            #edit_charge_submit[data-kt-indicator="on"] .indicator-label {
                display: inline-block !important;
            }
        </style>
        @endpush
