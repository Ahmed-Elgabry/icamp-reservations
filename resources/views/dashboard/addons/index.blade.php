        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Add customer-->
                    @can('addons.create')
                    <a href="{{ route('addons.create')}}" class="btn btn-primary">@lang('dashboard.create_title', ['page_title' => __('dashboard.addons')])</a>
                    @endcan 
                    <!--end::Add customer-->
                            ...
                            <tr data-id="{{$addon->id}}">
                                ...
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid ">
                                        <input class="form-check-input checkSingle" type="checkbox" value="1" id="{{$addon->id}}"/>
                                    </div>
                                </td>
                                <!--end::Checkbox-->
                                <!--begin::Category=-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('addons.show', $addon->id)}}" class="menu-link px-3"> @lang('dashboard.show')</a>
                                        </div>
                                        @endcan 
                                        @can('addons.edit')
                                        <div class="menu-item px-3">
                                            <a href="{{route('addons.edit', $addon->id)}}" class="menu-link px-3"> @lang('dashboard.edit')</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                        @can('addons.destroy')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-url="{{route('addons.destroy', $addon->id)}}" data-id="{{$addon->id}}"> @lang('dashboard.delete')</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                    </div>
