    ...
    <div class="card-header border-0 pt-6">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="card-title mb-0">
                <form method="GET" action="{{ route('whatsapp-templates.index') }}" class="d-flex align-items-center gap-3">
                    ...
                    @if(request()->has('type'))
                    <a href="{{ route('whatsapp-templates.index') }}" class="btn btn-light btn-sm">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('manual-whatsapp-sends.index') }}" class="btn btn-sm btn-success">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input status-toggle"
                                    @if(!Auth::user()->can('whatsapp-templates.toggle-status')) disabled @endif
                                type="checkbox"
                                data-id="{{ $template->id }}"
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                @can('whatsapp-templates.show')
                                <div class="menu-item px-3">
                                    <a href="{{ route('whatsapp-templates.show', $template->id) }}" class="menu-link px-3">@lang('dashboard.view')</a>
                                </div>
                                @endcan
                                @can('whatsapp-templates.edit')
                                <div class="menu-item px-3">
                                    <a href="{{ route('whatsapp-templates.edit', $template->id) }}" class="menu-link px-3">@lang('dashboard.edit')</a>
                                </div>
                                @endcan
                                @can('whatsapp-templates.edit')
                                <div class="menu-item px-3">
    ...
    $(document).ready(function() {
        ...
        $('#confirmDelete').click(function() {
            if (deleteTemplateId) {
                const form = $('<form>', {
                    method: 'POST',
                    action: `/whatsapp-templates/${deleteTemplateId}`
                });
