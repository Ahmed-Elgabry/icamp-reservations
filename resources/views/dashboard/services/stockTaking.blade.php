...
@endpush
    ...
    @if(isset($reportTaking) && $reportTaking->count())
    ...
    <table class="table table-responsive" id="stock-table">
            <thead>
                <tr>
                    ...
                    <th class="min-w-200">{{ __('dashboard.manual_item_withdrawal_and_return.correct_quantity') }}</th>
                    ...
                    <th class="min-w-200">{{ __('dashboard.manual_item_withdrawal_and_return.verification') }}</th>
        ...
        <table class="table table-responsive">
            <thead>
                <tr>
                    ...
                    <th class="min-w-200">{{ __('dashboard.manual_item_withdrawal_and_return.by') }}</th>
                    <th class="min-w-200">{{ __('dashboard.manual_item_withdrawal_and_return.date_time') }}</th>
                    <th class="min-w-200">{{ __('dashboard.manual_item_withdrawal_and_return.action') }}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>
                        <select name="type" class="form-control w-auto" required>
                            ...
                            <option value="item_decrement">{{ __('dashboard.manual_item_withdrawal_and_return.decrement') }}</option>
                            <option value="item_increment">{{ __('dashboard.manual_item_withdrawal_and_return.increment') }}</option>
                        </select>
                    </td>
                    <td>
                        <select name="reason" class="form-control reason-select w-auto" required>
                            ...
                            <option value="stockTaking">{{ __('dashboard.manual_item_withdrawal_and_return.reason_options.stockTaking') }}</option>
            ...
            <div class="modal-content">
                ...
                <form id="edit-adjustment-form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group d-flex align-items-center">
                            <label class="label-min-w">{{ __('dashboard.manual_item_withdrawal_and_return.correct_quantity') }}</label>
                        ...
                        <div class="form-group d-flex align-items-center">
                            ...
                            <select name="type" id="edit-type-select" class="form-control ml-2 w-auto" required>
                                <option value="">{{ __('dashboard.manual_item_withdrawal_and_return.select_type') }}</option>
                                <option value="stockTaking_decrement">{{ __('dashboard.manual_item_withdrawal_and_return.type_decrement') }}</option>
                                <option value="stockTaking_increment">{{ __('dashboard.manual_item_withdrawal_and_return.type_increment') }}</option>
                            </select>
                        </div>
                        <div class="form-group d-flex align-items-center">
