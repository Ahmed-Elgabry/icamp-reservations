...
<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
    ...
    <div class="menu-item menu-sub-indention menu-accordion  {{areActiveRoutes(['addons.index', 'addons.show', 'addons.create', 'addons.edit', 'stock-quantities.show'])}}"
        ...
        <div class="menu-sub menu-sub-accordion pt-3">
            ...
            <div class="menu-item">
                ...
                <a href="{{ route('pages.tasks.index') }}" class="menu-link py-3 {{ request()->routeIs('bookings.tasks.*') ? 'active' : '' }}">
    ...
    <div class="menu-item menu-sub-indention menu-accordion {{areActiveRoutes(['contact-guides.index','contact-guides.create','contact-guides.edit'])}}" data-kt-menu-trigger="click">
        ...
        <a href="#" class="menu-link py-3 {{areActiveRoutes(['contact-guides.index','contact-guides.create','contact-guides.edit'])}}">
            <span class="menu-icon">
    ...
    <div class="menu-item menu-sub-indention menu-accordion {{areActiveRoutes(['pages.index', 'pages.create', 'pages.edit'])}}"
        ...
        <div class="menu-sub menu-sub-accordion pt-3">
            ...
            @can('pages.reservations.board.today')

            <div class="menu-item">

                <a href="{{ route('pages.reservations.board.today') }}" class="menu-link py-3 {{ isActiveroute('pages.reservations.board.today') }} {{ isActiveroute('pages.reservations.board') }}">
            ...
            @endcan
            @can('pages.reservations.board.upcoming')


            <div class="menu-item">

                <a href="{{ route('pages.reservations.board.upcoming') }}" class="menu-link py-3 {{ isActiveroute('pages.reservations.board.upcoming') }}">
            ...
            @endcan
            @can('pages.tasks.index')

            <div class="menu-item">

                <a href="{{ route('pages.tasks.index') }}" class="menu-link py-3 {{ request()->routeIs('pages.tasks.*') ? 'active' : '' }}">
