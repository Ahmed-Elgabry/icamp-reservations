    ...
    <div class="modal-content">
      ...
      <div class="modal-body py-10 px-lg-15">
        <form id="additionalNotesForm" class="form">
          ...
          <div class="row mb-8"><div><textarea id="showPriceEditor" class="form-control notes-editor" rows="6"></textarea></div></div>

          <label class="col-form-label fw-bold fs-6">@lang('dashboard.order_data_notes')</label>
          <div class="row mb-8"><div><textarea id="orderDataEditor" class="form-control notes-editor" rows="6"></textarea></div></div>

          <label class="col-form-label fw-bold fs-6">@lang('dashboard.invoice_notes')</label>
          <div class="row mb-8"><div><textarea id="invoiceEditor" class="form-control notes-editor" rows="6"></textarea></div></div>

          <label class="col-form-label fw-bold fs-6">@lang('dashboard.receipt_notes')</label>
          <div class="row mb-8"><div><textarea id="receiptEditor" class="form-control notes-editor" rows="6"></textarea></div></div>
        </form>
      </div>
      <div class="modal-footer">
