    ...
    <div class="card mb-5 mb-xl-10">
      <div class="card-header border-0 align-items-center justify-content-between">
        <div class="card-title m-0 d-flex align-items-center gap-3 flex-wrap">
          <form method="get" action="{{ $formAction ?? route('pages.reservations.board') }}" class="d-flex align-items-center gap-2">
            ...
            <a href="{{ route('pages.reservations.board') }}" class="btn btn-sm btn-light">@lang('dashboard.clear')</a>
            @endif
          </form>
        </div>
