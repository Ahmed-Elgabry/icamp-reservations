                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-5">
                        ...
                        <div class="form-group">
                            ...
                            <label for="" class="fw-bolder">{{ __('dashboard.account_name') }}</label>
                    ...
                    <div class="col-md-4 mt-5">
                        ...
                        <div class="form-group">
                            ...
                            <label for="end_date" class="fw-bolder">{{ __('dashboard.account_balance') }}:</label>
                    ...
                    <div class="col-md-4 mt-5">
                        ...
                        <div class="form-group">
                            ...
                            <label for="end_date" class="fw-bolder">{{ __('dashboard.account_number') }}:</label>
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="@lang('dashboard.search_title', ['page_title' => __('dashboard.funds')])" />
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('payments.create' ,$bank->id) }}" class="btn btn-primary">

                            @lang('dashboard.add_funds')
