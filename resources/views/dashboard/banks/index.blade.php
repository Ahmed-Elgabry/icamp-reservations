        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('bank-accounts.create')}}" class="btn btn-primary">@lang('dashboard.create_title', ['page_title' => __('dashboard.bank-accounts')])</a>
                    @endcan 
                    <!--end::Add customer-->
                    <span class="w-5px h-2px"></span>
                    @can('bank-accounts.deleteAll')
                            ...
                            <tr data-id="{{$bank->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{ route('bank-accounts.show', $bank->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">
                                                @if($bank->account_number) {{$bank->account_number   }} <br> @endif 
                                ...
                                <td> {{$bank->balance }} {{$bank->curruncy}}</td>
                                <td>{{$bank->notes}}</td>
                                <!--begin::Action=-->
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('bank-accounts.show', $bank->id)}}" class="menu-link px-3">@lang('dashboard.show')</a>
                                        </div>
                                        @endcan 

                                        @can('bank-accounts.edit')
                                        <div class="menu-item px-3">
                                            <a href="{{route('bank-accounts.edit', $bank->id)}}" class="menu-link px-3">@lang('dashboard.edit')</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-url="{{route('bank-accounts.destroy', $bank->id)}}" data-id="{{$bank->id}}">@lang('dashboard.delete')</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                    </div>
