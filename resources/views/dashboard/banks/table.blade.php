        ...
        <tr data-id="{{$transaction->id}}">
            ...
            <td>
                ...
                <span class="badge badge-primary">
                    <a href="{{   route('bank-accounts.show', $transaction->id) }}" class="text-light">
            ...
            <td>
                ...
                <span class="badge  badge-primary">
                    <a href="{{ $transaction->receiver ? route('bank-accounts.show', $transaction->receiver->id) : '#' }}"
                        class="text-light">
