...
<div class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center d-flex flex-row flex-nowrap">
                            ...
                            @endcan
                            @can('bookings.service-site-customer-service.delete')
                            <form action="{{ route('bookings.service-site-customer-service.delete', $row->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('{{ __('dashboard.delete_confirmation') }}');">
                                @csrf
                                @method('DELETE')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const quillService = new Quill('#editor-serviceSite', {
                theme: 'snow',
                modules: {
                    toolbar: toolbarOptions
                }
            });
            const quillEn = new Quill('#editor-workername-en', {
                theme: 'snow',
                modules: {
                    toolbar: toolbarOptions
                }
            });
            const quillAr = new Quill('#editor-workername-ar', {
                theme: 'snow',
                modules: {
                    toolbar: toolbarOptions
                }
