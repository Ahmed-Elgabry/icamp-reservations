    ...
    (function() {
        ...
        $$('#rfTableBody .rf-view').forEach(btn => {
            ...
            btn.addEventListener('click', () => {
                let obj = {};
                try {
                    obj = JSON.parse(btn.getAttribute('data-details'));
                } catch (e) {}
        ...
        let onConfirm = null;
        $('#rfConfirmOk').addEventListener('click', () => {
            if (onConfirm) {
                onConfirm();
            }
            confirmModal.hide();
        ...
        $$('#rfTableBody .rf-book').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                askConfirm('{{ __('
                    dashboard.confirm_reservation_title ') }}', '{{ __('
                    dashboard.confirm_reservation_body ') }}', () => {
        ...
        $$('#rfTableBody .rf-delete').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                askConfirm('{{ __('
                    dashboard.confirm_delete_title ') }}', '{{ __('
                    dashboard.confirm_delete_body ') }}', () => {
                        form.submit();
                    });
            });
        });
