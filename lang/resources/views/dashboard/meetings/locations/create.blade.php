...
@section('pageTitle', __('dashboard.create_location'))

@section('content')
    <div class="card card-flush shadow-sm">
        <div class="card-header border-0 pt-6">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">@lang('dashboard.create_location')</span>
            </h3>
        ...
        <div class="card-body pt-0">
            <form action="{{ route('meeting-locations.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>@lang('dashboard.save_location')
                    </button>
                </div>
            </form>
        </div>
