...
<div class='fs-6 text-gray-700'>For additional security, confirmation via email or phone will be required when resetting login password.",
    ...
    'payment_link_errors' => [
        'invalid_customer' => 'The order does not contain a valid customer',
        'creation_failed' => 'Failed to create payment link: :error',
        'unknown_error' => 'Unknown error',
        'creation_error' => 'An error occurred while creating the payment link',
        'resend_failed' => 'Failed to resend payment link',
        'resend_error' => 'An error occurred while resending the payment link',
        'cancel_failed' => 'Failed to cancel payment link',
        'cancel_error' => 'An error occurred while cancelling the payment link',
        'delete_error' => 'An error occurred while deleting the payment link',
        'status_update_failed' => 'Failed to update payment status',
        'status_update_error' => 'An error occurred while updating payment status',
    ],
    ...
    'payment_links_for_order' => 'Payment Links - Order #:order_id (:customer_name)',
    ...
    'status' => 'Status',
    'actions' => 'Actions',
    'qr_code_title' => 'QR Code for Payment',
    'qr_code_coming_soon' => 'QR Code will be added soon',
    'open_payment_link' => 'Open Payment Link',
    'no_payment_links' => 'No payment links currently',
