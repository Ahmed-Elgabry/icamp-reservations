            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="<?php echo app('translator')->get('dashboard.search_title', ['page_title' => __('dashboard.expenses')]); ?>" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--end::Card title-->
 ...
 <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <td><?php echo e(__('dashboard.statement')); ?></td>
                    <th><?php echo e(__('dashboard.price')); ?></th>
                    <th class=""><?php echo e(__('dashboard.payment_method')); ?></th>
                    <th class=""><?php echo e(__('dashboard.debit')); ?> <?php echo e(__('dashboard.from')); ?></th>
            ...
            <tbody class="fw-bold text-gray-600">
                <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!--begin::Table row-->
                    <tr data-id="<?php echo e($payment->id); ?>">
                        ...
                        <!--begin::Category=-->
                        <td><?php echo e($payment->statement); ?></td>
                        <td>
                            <div class="d-flex">
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                        ...
                        <td>
                            <?php echo e($payment->payment_method ? __('dashboard.' . $payment->payment_method) : __('dashboard.not_specified')); ?>

                        </td>
                        <td>
                            <?php echo e($payment->account ? $payment->account->name :""); ?>
                        ...
                        <td>
                            ...
                            <?php if($payment->verified): ?>
                                <a href="<?php echo e(route('order.verified' , [$payment->id , 'expense'])); ?>" class="btn btn-sm btn-danger" ><?php echo e(__('dashboard.mark')); ?> <?php echo e(__('dashboard.unverifyed')); ?></a>
                            <?php else: ?>
                                <a href="<?php echo e(route('order.verified' , [$payment->id , 'expense'])); ?>" class="btn btn-sm btn-success"><?php echo e(__('dashboard.mark')); ?> <?php echo e(__('dashboard.verified')); ?></a>
                            <?php endif; ?>
                        </td>
                        <td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expenses.edit')): ?>
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expenses.destroy')): ?>
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-url="<?php echo e(route('expenses.destroy', $payment->id)); ?>" data-id="<?php echo e($payment->id); ?>"> <?php echo app('translator')->get('dashboard.delete'); ?></a>
                                </div>
                                <?php endif; ?>
                            <!--end::Menu item-->
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo e(route('expenses.update',$payment->id)); ?>" id="editCountForm<?php echo e($payment->id); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-5 fv-row col-md-12">
                                <label for="account_id" class="required"><?php echo e(__('dashboard.debit')); ?><?php echo e(__('dashboard.from')); ?></label>
                                <select name="account_id" id="account_id" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                                 <?php echo e($payment->account_id == $bank->id ? 'selected' : ''); ?>
...
<div class="modal fade" id="addNewCount" tabindex="-1" role="dialog" aria-labelledby="addNewCountLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addNewCountLabel"> <?php echo app('translator')->get('dashboard.create_title', ['page_title' => __('dashboard.expenses')]); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?php echo e(route('expenses.store')); ?>" id="saveCountDetails" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <!--begin::Input group-->
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my projects\icamp-reservations\resources\views/dashboard/expenses/show.blade.php ENDPATH**/ ?>