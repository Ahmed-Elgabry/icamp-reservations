...
<head>
    <meta charset="utf-8">
    <title>توقيع الحجز رقم <?php echo e($order->id); ?></title>
...
<body>
    ...
    <div class="shell">
        ...
        <?php if($terms): ?>
            <div class="alert alert-warning">
                <strong>تنبيه:</strong> <?php echo $terms?->commercial_license_ar; ?>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <form id="sig-form" method="POST" action="<?php echo e(route('signature.store', $order)); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        dlB.addEventListener('click', () => {
            ...
            const a = document.createElement('a'); a.href = url; a.download = 'signature-order-<?php echo e($order->id); ?>.png';
...
<?php /**PATH C:\my projects\icamp-reservations\resources\views/signature/signature.blade.php ENDPATH**/ ?>