<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" direction="<?php echo e(app()->getLocale() == 'en' ? 'ltr' : 'rtl'); ?>" dir="<?php echo e(app()->getLocale() == 'en' ? 'ltr' : 'rtl'); ?>" style="direction: <?php echo e(app()->getLocale() == 'en' ? 'ltr' : 'rtl'); ?>">
<!--begin::Head-->

<head>
	<title><?php echo app('translator')->get('dashboard.app_name'); ?> | <?php echo $__env->yieldContent('pageTitle'); ?></title>
	<meta charset="utf-8" />
	<meta name="description" content="<?php echo app('translator')->get('dashboard.app_desc'); ?>" />
	<meta name="keywords" content="<?php echo app('translator')->get('dashboard.app_key_words'); ?>" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />
	<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>" />
	<meta property="og:locale" content="<?php echo e((App::isLocale('ar') ? 'ar_EG' : 'en_US')); ?>" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="<?php echo app('translator')->get('dashboard.app_name'); ?>" />
	<meta property="og:url" content="<?php echo e(Request::fullUrl()); ?>" />
	<meta property="og:image:type" content="image/png" />
	<meta property="og:image:width" content="1200" />
	<meta property="og:image:height" content="600" />
	<meta property="og:site_name" content="<?php echo app('translator')->get('dashboard.app_name'); ?>" />
	...
	<link href="<?php echo e(asset('dashboard/custom/css/main.css')); ?>" rel="stylesheet" />
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
	...
	<script src="<?php echo e(asset('dashboard/assets/js/jquery.js')); ?>"></script>
	<script src="<?php echo e(asset('dashboard/assets/js/popper.js')); ?>"></script>
	<script src="<?php echo e(asset('dashboard/assets/js/bootstrap.js')); ?>"></script>
	...
	<script src="<?php echo e(asset('dashboard/custom/js/dataTable.js')); ?>"></script>
	...
	<script src="<?php echo e(asset('dashboard/custom/plugins/jquery-localize/dist/jquery.localize.min.js')); ?>"></script>
	<script src="<?php echo e(asset('dashboard/custom/js/main.js')); ?>"></script>
	<script src="<?php echo e(asset('js/jquery.toast.js')); ?>"></script>
	<script src="<?php echo e(asset('dashboard/custom/js/jquery.validate.min.js')); ?>"></script>
	<?php if(lang() == "ar"): ?>
	<script src="<?php echo e(asset('dashboard/custom/js/messages_ar.js')); ?>"></script>
	<?php endif; ?>
	<script type="text/javascript" src="<?php echo e(URL::asset('dashboard/custom/plugins/axios/dist/axios.min.js')); ?>"></script>
	<script src="<?php echo e(asset('dashboard/custom/js/sending-forms.js')); ?>"></script>
...
<?php /**PATH C:\my projects\icamp-reservations\resources\views/dashboard/layouts/app.blade.php ENDPATH**/ ?>