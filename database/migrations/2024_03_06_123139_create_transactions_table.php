...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->foreign('order_addon_id')->references('id')->on('order_addon')->onDelete('set null');
            $table->foreign('payment_id')->references('id')->on('payments')->onDelete('set null');
            $table->foreign('receiver_id')->references('id')->on('bank_accounts')->onDelete('set null');
            $table->foreign('customer_id')->references('id')->on('customers')->onDelete('set null');
            $table->foreign('order_id')->references('id')->on('orders')->onDelete('set null');
            $table->foreign('sender_account_id')->references('id')->on('bank_accounts')->onDelete('set null');
