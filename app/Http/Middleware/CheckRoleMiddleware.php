...
class CheckRoleMiddleware {
  ...
  public function handle($request, Closure $next) {
    ...
    //    dd(auth()->user()->roles()->first());
        ...
        // some exception
        $excpetions = ['edit-profile','home','logout','payments.print','orders.quote','orders.invoice','addons.print', 'warehouse_sales.show' , 'warehouse_sales.store' , 'warehouse_sales.destroy' , 'warehouse_sales.update' , 'stocks.destroyServiceStock' ,'order.verified','orders.accept_terms' , 'orders.updateNotes'];
