...
class CheckRoleMiddleware
{
  ...
  public function handle($request, Closure $next)
  {
    ...
    // some exception
    $excpetions = ['edit-profile', 'home', 'logout', 'payments.print', "money-transfer",'payments.transfer', 'orders.quote', 'orders.invoice', 'addons.print', 'warehouse_sales.show', 'warehouse_sales.store', 'warehouse_sales.destroy', 'warehouse_sales.update', 'stocks.destroyServiceStock', 'order.verified', 'payment-links.*' , 'payment-links.create' , 'payment-links.index', 'stock.decrement','orders.registeration-forms' , 'orders.registeration-forms.edit','orders.registeration-forms.destroy', 'orders.registeration-forms.fetch','orders.registeration-forms.search','orders.registeration-forms.update','orders.customers.check'];
